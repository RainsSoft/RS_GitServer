...
namespace RSGit
{
	public class RepoBuilder
	{
		...
		{
			this.basePath = Path.Combine(basePath, $"client\\{unittestguid}");
		...
		public RepoBuilder Clone(string url, string branch= "master") {
			var gitClient = new MiniGitNetworkClient();
			gitClient.CloneBranch(Git, "origin", url, branch);
			return this;
        }
