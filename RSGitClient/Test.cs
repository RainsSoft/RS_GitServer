...
namespace RSGitClient
{
    ...
    public class KbGitTests
    {
        ...
        public string FileSystemScanFolder(MiniGit git)
        {
  ...
  master", repoBuilder.Git.Branches.ListBranches());
    ...
    public class NetworkingTests
    {
        ...
        public void When_pulling_Then_receive_all_nodes()
        {
            ...
            new MiniGitNetworkClient().PullBranch(localGit.Hd.Remotes.First(), "master", localGit);
...
", actual);
        ...
        public void When_pushing_Then_push_nodes_and_update_branchpointer_on_server()
        {
            ...
            new MiniGitNetworkClient().PushBranch(localGit.Hd.Remotes.First(), "master", branch, null, commits);
